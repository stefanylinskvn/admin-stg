import { apelidoRand, corPeleRand, tipoSanguineoRand, orientacaoSexualRand, identidadeGeneroRand, identidadePorOrientacaoRand, provedorEmailRand, categoriaCnhRand, profissaoRand, escolaridadeRand } from './utils.mjs';
import { banco, listaCodigosBancos } from './generators/banco.mjs';
import { palavra, sentenca, paragrafo } from './generators/texto.mjs';
import { placaAntiga, placaMercosul } from './generators/placa.mjs';
import { cartaoCredito } from './generators/cartao-credito.mjs';
import { celular } from './generators/celular.mjs';
import { cep } from './generators/cep.mjs';
import { certidao } from './generators/certidao.mjs';
import { cnh } from './generators/cnh.mjs';
import { cnpj } from './generators/cnpj.mjs';
import { cns } from './generators/cartao-nacional-saude.mjs';
import { codigoOperadora } from './generators/operadora.mjs';
import { contaBancaria } from './generators/conta-bancaria.mjs';
import { cpf } from './generators/cpf.mjs';
import { dataNascimento } from './generators/data-nascimento.mjs';
import { ddd } from './generators/ddd.mjs';
import { email } from './generators/email.mjs';
import { endereco } from './generators/endereco.mjs';
import { inscricaoEstadual } from './generators/inscricao-estadual.mjs';
import { nome } from './generators/nome.mjs';
import { passaporte } from './generators/passaporte.mjs';
import { pis } from './generators/pis.mjs';
import { renavam } from './generators/renavam.mjs';
import { rg } from './generators/rg.mjs';
import { telefone } from './generators/telefone.mjs';
import { tituloEleitor } from './generators/titulo-eleitor.mjs';
...
export { apelido, banco, cartaoCredito, celular, cep, certidao, cnh, cnhCategoria, cnpj, cns, codigoOperadora, contaBancaria, corPele, cpf, dataNascimento, ddd, email, endereco, escolaridade, gerar, identidadeGenero, identidadePorOrientacao, inscricaoEstadual, listaCodigosBancos, nome, orientacaoSexual, palavra, paragrafo, passaporte, pis, placaAntiga, placaMercosul, profissao, provedorEmail, renavam, rg, sentenca, telefone, tipoSanguineo, tituloEleitor };

 ...
 */
function palavra() {
  return dbGeneral.palavras[Math.floor(Math.random() * dbGeneral.palavras.length)];
}
 ...
 */
function paragrafo(qttParagraph = 1, qttWords) {

...
const identidesGenero = [
  'Cisgênero', 'Transgênero', 'Não binário',
];
const identidadesPorOrientacao = {
  Heterossexual: ['Cisgênero', 'Transgênero'],
  Homossexual: ['Cisgênero', 'Transgênero'],
  Bissexual: ['Cisgênero', 'Transgênero', 'Não binário'],
  Assexual: ['Cisgênero', 'Transgênero', 'Não binário'],
  Pansexual: ['Cisgênero', 'Transgênero', 'Não binário'],
};
const corPele = ['Branca', 'Preta', 'Parda', 'Amarela', 'Outro'];

const tiposSanguineo = ['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'];

const categoriasCnh = ['ACC', 'A', 'B', 'C', 'D', 'E', 'AB', 'AC', 'AD', 'AE'];
...
exports.categoriasCnh = categoriasCnh;
exports.corPele = corPele;
exports.escolaridade = escolaridade;
exports.identidadesPorOrientacao = identidadesPorOrientacao;
exports.identidesGenero = identidesGenero;
exports.nicknames = nicknames;
exports.nomesDoMeio = nomesDoMeio;
exports.nomesFemininos = nomesFemininos;
exports.nomesMasculinos = nomesMasculinos;
exports.orientacaoSexual = orientacaoSexual;
exports.palavras = palavras;
exports.profissao = profissao;
exports.provedoresEmail = provedoresEmail;
exports.siglasEstados = siglasEstados;
exports.sobrenomes = sobrenomes;
exports.tiposSanguineo = tiposSanguineo;
